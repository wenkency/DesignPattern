package cn.lven.router.compiler.utils;
...
public class Consts {
    ...
    public static final ClassName ROUTER = ClassName.get("cn.lven.router.core", "XRouter");

    public static final String ARGUMENTS_NAME = "moduleName";
    // 过滤的注解类
    public static final String ANN_TYPE_ROUTE = "cn.lven.router.annotation.Router";
    

    public static final String ANN_TYPE_Extra = "cn.lven.router.annotation.Extra";


    public static final String IROUTE_GROUP = "cn.lven.router.core.template.IRouteGroup";
    public static final String IROUTE_ROOT = "cn.lven.router.core.template.IRouteRoot";
    public static final String IEXTRA = "cn.lven.router.core.template.IExtra";

    public static final String METHOD_LOAD_INTO = "loadInto";
    public static final String METHOD_LOAD_EXTRA = "loadExtra";

    public static final String ACTIVITY = "android.app.Activity";
    public static final String ISERVICE = "cn.lven.router.core.template.IService";
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = "cn.lven.router.routes";
}
